...
class EOLoginController extends Controller
{
    ...
    */
    ...
    {
        $this->middleware('guest:eo_auth')->except('logout');
    }
    /**
    ...
    public function loginAdmin(Request $request)
    {
        ...
        if (Auth::guard('eo_auth')->attempt(['email' => $request->email, 'password' => $request->password], $request->remember)) {
